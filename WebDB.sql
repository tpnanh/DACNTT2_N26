...
go 
insert into ministry_legislation_detail_configuration(ministry_id, legislation_id, legislation_url_xpath, page_rule, schedule_minute, legislation_param_xpath) values
	--văn bản bộ công an
	(1, 3,
...
insert into legislation_configuration( legislation_name_xpath, legislation_so_hieu_van_ban, legislation_ngay_ban_hanh, legislation_ngay_hieu_luc, 
	...
	go	
INSERT INTO legislationinfo(ministry_id,legislation_name,legislation_category_type_id,legislation_link_root)
VALUES
